...
did not. The result is a bounded execution mechanism, not universal
linearization or universal speed.
...
that incremental execution is always the fastest path.
