...
~~~bibtex
@misc{mack_sspm_state_aware_2026,
  author       = {Ronnie Mack},
  title        = {State-Aware Computing: Exact Local Reuse for Repeated System Intervention},
  year         = {2026},
  month        = {July},
...
When citing an empirical result, identify the application family, sparse/dense
regime, timing boundary, and source workbench revision. Do not cite a local
speed ratio as a universal runtime property.
